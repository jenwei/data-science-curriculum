...
__q2__ Create a visualization of `df_antibiotics` that helps you to categorize bacteria according to the variables in the data. Document your observations on how clusters of bacteria in the variables do---or don't---align with their *genus* classification.
